...
const file_asset_proto_rawDesc = "" +
	...
	"\fAssetService\x12;\n" +
	"\bGetAsset\x12\x16.proto.GetAssetRequest\x1a\x17.proto.GetAssetResponseB0Z.github.com/shatwik7/polycrate/libs/proto;protob\x06proto3"
...
var file_asset_proto_goTypes = []any{
	(*GetAssetRequest)(nil),  // 0: proto.GetAssetRequest
	(*GetAssetResponse)(nil), // 1: proto.GetAssetResponse
}
var file_asset_proto_depIdxs = []int32{
	0, // 0: proto.AssetService.GetAsset:input_type -> proto.GetAssetRequest
	1, // 1: proto.AssetService.GetAsset:output_type -> proto.GetAssetResponse
